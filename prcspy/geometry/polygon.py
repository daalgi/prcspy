#https://github.com/heineman/python-polygon-intersection/blob/master/Polygon/poly/polygon.py
#https://github.com/heineman/python-polygon-intersection/blob/master/Polygon/poly/convex_intersect.py
"""
